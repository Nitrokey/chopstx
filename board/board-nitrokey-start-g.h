...
#define DELIBARATELY_DO_IT_WRONG_START_STOP 0//(detect_chip()->clock.i_DELIBARATELY_DO_IT_WRONG_START_STOP)
// STM32_USBPRE_DIV1P5: GD32 -> STM32_USBPRE_DIV2 STM32 -> STM32_USBPRE_DIV1P5
#define STM32_USBPRE            STM32_USBPRE_DIV2//(detect_chip()->clock.i_STM32_USBPRE)
